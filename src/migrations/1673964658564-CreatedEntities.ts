...
export class CreatedEntities1673964658564 implements MigrationInterface {
    name = 'CreatedEntities1673964658564'

    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`CREATE TABLE "checkpoint" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "entry" TIME NOT NULL, "output" TIME, "date" date NOT NULL, "user_id" uuid, "projects_id" uuid, CONSTRAINT "PK_fea86db187949398f8b614f730a" PRIMARY KEY ("id"))`);
